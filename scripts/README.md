...
- `install-hermes-legion-commander.ps1` / `.sh`: install or repair v2.0.0 in a dedicated virtual environment. The installer removes stale `hermes-legion-commander` and legacy `legion-commander` package files from that environment.
